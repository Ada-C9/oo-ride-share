...
describe "Passenger class" do
  ...
  describe "get_drivers method" do
    before do
      ...
      trip = RideShare::Trip.new({id: 8, driver: driver, passenger: @passenger, start_time: Time.new("2016-04-05T14:01:00+00:00"), end_time: Time.new("2016-04-05T14:09:00+00:00"), date: "2016-08-08", rating: 5})
