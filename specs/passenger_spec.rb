...
describe "Passenger class" do
  ...
  describe "trips property" do
    before do
      ...
      trip = RideShare::Trip.new({id: 8, driver: nil, passenger: @passenger, start_time: "2016-08-08", end_time: "2016-08-08T01:11:00+00:00", rating: 5})
  ...
  describe "get_drivers method" do
    before do
      ...
      trip = RideShare::Trip.new({id: 8, driver: driver, passenger: @passenger, start_time: "2016-08-08", end_time: "2016-08-08T01:11:00+00:00", rating: 5})
