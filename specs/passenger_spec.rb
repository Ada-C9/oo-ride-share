...
describe "Passenger class" do
  ...
  describe "total_amount_of_money" do
    before do
      start_time = Time.parse('2015-11-18T18:32:00+00:00')
      end_time = Time.parse('2016-04-05T14:01:00+00:00')
      @passenger = RideShare::Passenger.new(id: 8, name: "Dariana Bernhard IV", phone: "1-904-093-5211 x9183",trips:[])
      driver = RideShare::Driver.new(id: 3, name: "Lovelace", vin: "12345678912345678")
      @trip = RideShare::Trip.new({id: 8, driver: driver, passenger: 54, start_time: start_time,end_time: end_time,cost:17.39,rating: 5})
  ...
  describe "trips property" do
    before do
      ...
      trip = RideShare::Trip.new({id: 8, driver: nil, passenger: @passenger, start_time: Time.parse('2016-08-08T16:01:00+00:00'),
        end_time: Time.parse('2016-08-08T16:37:00+00:00'),rating: 5})
  ...
  describe "get_drivers method" do
    before do
      ...
      driver = RideShare::Driver.new(id: 3, name: "Lovelace", vin: "12345678912345678")
      trip = RideShare::Trip.new({id: 8, driver: driver, passenger: @passenger, start_time: Time.parse('2016-08-08T16:01:00+00:00'),end_time: Time.parse('2016-08-08T16:37:00+00:00'), rating: 5})
