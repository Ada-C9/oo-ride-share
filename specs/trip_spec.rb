...
describe "Trip class" do
  ...
  describe 'calculate_duration method' do
    it 'can return the duration of the ride in seconds' do
      @trip.calculate_duration.must_be_kind_of Integer
      @trip.calculate_duration.must_equal 1500
    end
  end#end calculate_duration describe
end#end trip class describe
