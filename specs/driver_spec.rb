...
describe "Driver class" do
  ...
  describe "add trip method" do
    before do
      ...
      @trip = RideShare::Trip.new({id: 8, driver: @driver, passenger: pass, start_time: '2015-05-20T12:14:00+00:00', end_time: '2015-05-20 12:39:00', rating: 5})
    end
  ...
  describe "average_rating method" do
    before do
      ...
      trip = RideShare::Trip.new({id: 8, driver: @driver, passenger: nil, start_time: '2015-05-20T12:14:00+00:00', end_time: '2015-05-20 12:39:00', rating: 5})
      @driver.add_trip(trip)
    end
