...
describe "Driver class" do
  ...
  describe "add trip method" do
    before do
      ...
      @trip = RideShare::Trip.new({id: 8, driver: @driver, passenger: pass, start_time: start_time, end_time: end_time, cost: 12.50, rating: 5})
    end
  ...
  describe "average_rating method" do
    before do
      ...
      trip = RideShare::Trip.new({id: 8, driver: @driver, passenger: nil, start_time: start_time, end_time: end_time, cost: 12.50, rating: 5})
  ...
  describe "total revenue method" do
    before do
      ...
      trip = RideShare::Trip.new({id: 8, driver: @driver, passenger: nil, start_time: start_time, end_time: end_time, cost: 12.50, rating: 5})
      trip2 = trip = RideShare::Trip.new({id: 8, driver: @driver, passenger: nil, start_time: start_time, end_time: end_time, cost: 8.50, rating: 3})
    ...
    it "returns total revenue" do
      ...
      @driver.trips.each do |trip|
        trip = (trip.cost - 1.65) * 0.8
        driver_money += trip
      end

      @driver.total_revenue.must_equal driver_money
  ...
  describe "average revenue per hour method" do
    before do
      start_time = Time.parse('2015-05-20T12:14:00+00:00')
      end_time = Time.parse('2015-05-20T12:44:00+00')
    ...
    it "returns average revenue per hour" do
      @driver.average_revenue_per_hour.must_be :>, 0
