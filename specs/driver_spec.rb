...
describe "Driver class" do
  ...
  describe "add trip method" do
    before do
      ...
      @trip = RideShare::Trip.new({id: 8, driver: @driver, passenger: pass, start_time: '2015-05-20T12:15:00+00:00', end_time: '2015-05-20T12:35:00+00:00', rating: 5})
    end
  ...
  describe "average_rating method" do
    before do
      ...
      trip = RideShare::Trip.new({id: 8, driver: @driver, passenger: nil, start_time: '2015-05-20T12:15:00+00:00', end_time: '2015-05-20T12:35:00+00:00', rating: 5})
      @driver.add_trip(trip)
    end
  ...
  describe "revenue methods" do
    before do
      @driver = RideShare::Driver.new(id: 54, name: "Rogers Bartell IV", vin: "1C9EVBRM0YBC564DZ")
      trip = RideShare::Trip.new({id: 8, driver: @driver, passenger: nil, start_time: '2015-05-20T12:15:00+00:00', end_time: '2015-05-20T12:35:00+00:00', cost: 10.50, rating: 5})
      @driver.add_trip(trip)
    end

    it "returns the total revenue" do
      @driver.total_revenue.must_be_kind_of Float
      @driver.total_revenue.must_equal 7.08
    end
